...
- Replace all occurrences of "Sub0Ent" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `Sub0Ent` means the name of the project, while `sub0ent` is used in file names.
  - Remember to rename the `include/sub0ent` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
